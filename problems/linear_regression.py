...
X_0 = np.zeros(DIM)
ALPHA = 1
# TODO: Regarder la loi de descente - solution_analytique
"""
Fixer la seed du problème et changer la seed pour les runs de l'algo d'optim
"""
